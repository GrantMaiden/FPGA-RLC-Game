...
// 
// Generated using ACDS version 14.0 200 at 2017.05.27.01:58:42
...
module RLC_game_system_mm_interconnect_0 (
	...
	wire   [9:0] cmd_mux_002_src_channel;                                                   // cmd_mux_002:src_channel -> cpu_jtag_debug_module_agent:cp_channel
	...
	wire   [9:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> onchip_mem_s1_agent:cp_channel
	...
	wire   [9:0] cmd_mux_004_src_channel;                                                   // cmd_mux_004:src_channel -> sys_clk_timer_s1_agent:cp_channel
	...
	wire         cmd_mux_006_src_endofpacket;                                               // cmd_mux_006:src_endofpacket -> switches_pio_s1_agent:cp_endofpacket
	wire         cmd_mux_006_src_valid;                                                     // cmd_mux_006:src_valid -> switches_pio_s1_agent:cp_valid
	wire         cmd_mux_006_src_startofpacket;                                             // cmd_mux_006:src_startofpacket -> switches_pio_s1_agent:cp_startofpacket
	wire  [97:0] cmd_mux_006_src_data;                                                      // cmd_mux_006:src_data -> switches_pio_s1_agent:cp_data
	wire   [9:0] cmd_mux_006_src_channel;                                                   // cmd_mux_006:src_channel -> switches_pio_s1_agent:cp_channel
	wire         cmd_mux_006_src_ready;                                                     // switches_pio_s1_agent:cp_ready -> cmd_mux_006:src_ready
	...
	wire         cmd_mux_007_src_endofpacket;                                               // cmd_mux_007:src_endofpacket -> DataIn_pio_s1_agent:cp_endofpacket
	wire         cmd_mux_007_src_valid;                                                     // cmd_mux_007:src_valid -> DataIn_pio_s1_agent:cp_valid
	wire         cmd_mux_007_src_startofpacket;                                             // cmd_mux_007:src_startofpacket -> DataIn_pio_s1_agent:cp_startofpacket
	wire  [97:0] cmd_mux_007_src_data;                                                      // cmd_mux_007:src_data -> DataIn_pio_s1_agent:cp_data
	wire   [9:0] cmd_mux_007_src_channel;                                                   // cmd_mux_007:src_channel -> DataIn_pio_s1_agent:cp_channel
	wire         cmd_mux_007_src_ready;                                                     // DataIn_pio_s1_agent:cp_ready -> cmd_mux_007:src_ready
	...
	wire         cmd_mux_008_src_endofpacket;                                               // cmd_mux_008:src_endofpacket -> KEYin_pio_s1_agent:cp_endofpacket
	wire         cmd_mux_008_src_valid;                                                     // cmd_mux_008:src_valid -> KEYin_pio_s1_agent:cp_valid
	wire         cmd_mux_008_src_startofpacket;                                             // cmd_mux_008:src_startofpacket -> KEYin_pio_s1_agent:cp_startofpacket
	wire  [97:0] cmd_mux_008_src_data;                                                      // cmd_mux_008:src_data -> KEYin_pio_s1_agent:cp_data
	wire   [9:0] cmd_mux_008_src_channel;                                                   // cmd_mux_008:src_channel -> KEYin_pio_s1_agent:cp_channel
	wire         cmd_mux_008_src_ready;                                                     // KEYin_pio_s1_agent:cp_ready -> cmd_mux_008:src_ready
	...
	wire   [9:0] cmd_mux_009_src_channel;                                                   // cmd_mux_009:src_channel -> DataOut_pio_s1_agent:cp_channel
	...
	wire         switches_pio_s1_agent_rp_endofpacket;                                      // switches_pio_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	wire         switches_pio_s1_agent_rp_valid;                                            // switches_pio_s1_agent:rp_valid -> router_008:sink_valid
	wire         switches_pio_s1_agent_rp_startofpacket;                                    // switches_pio_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire  [97:0] switches_pio_s1_agent_rp_data;                                             // switches_pio_s1_agent:rp_data -> router_008:sink_data
	wire         switches_pio_s1_agent_rp_ready;                                            // router_008:sink_ready -> switches_pio_s1_agent:rp_ready
	...
	wire         datain_pio_s1_agent_rp_endofpacket;                                        // DataIn_pio_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	wire         datain_pio_s1_agent_rp_valid;                                              // DataIn_pio_s1_agent:rp_valid -> router_009:sink_valid
	wire         datain_pio_s1_agent_rp_startofpacket;                                      // DataIn_pio_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire  [97:0] datain_pio_s1_agent_rp_data;                                               // DataIn_pio_s1_agent:rp_data -> router_009:sink_data
	wire         datain_pio_s1_agent_rp_ready;                                              // router_009:sink_ready -> DataIn_pio_s1_agent:rp_ready
	...
	wire         keyin_pio_s1_agent_rp_endofpacket;                                         // KEYin_pio_s1_agent:rp_endofpacket -> router_010:sink_endofpacket
	wire         keyin_pio_s1_agent_rp_valid;                                               // KEYin_pio_s1_agent:rp_valid -> router_010:sink_valid
	wire         keyin_pio_s1_agent_rp_startofpacket;                                       // KEYin_pio_s1_agent:rp_startofpacket -> router_010:sink_startofpacket
	wire  [97:0] keyin_pio_s1_agent_rp_data;                                                // KEYin_pio_s1_agent:rp_data -> router_010:sink_data
	wire         keyin_pio_s1_agent_rp_ready;                                               // router_010:sink_ready -> KEYin_pio_s1_agent:rp_ready
	...
	RLC_game_system_mm_interconnect_0_router_002 router_003 (
	...
	RLC_game_system_mm_interconnect_0_router_004 router_004 (
	...
	RLC_game_system_mm_interconnect_0_router_004 router_005 (
	...
	RLC_game_system_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	RLC_game_system_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	RLC_game_system_mm_interconnect_0_cmd_mux_002 cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	RLC_game_system_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	RLC_game_system_mm_interconnect_0_cmd_demux_001 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
